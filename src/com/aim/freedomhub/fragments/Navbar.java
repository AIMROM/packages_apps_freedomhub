...
public class Navbar extends SettingsPreferenceFragment implements
    ...
    private static final String NAVBAR_ENABLED = "force_show_navbar";
    private static final String KEY_NAVIGATION_HOME_LONG_PRESS = "navigation_home_long_press";
    private static final String KEY_NAVIGATION_HOME_DOUBLE_TAP = "navigation_home_double_tap";
    private static final String KEY_NAVIGATION_APP_SWITCH_LONG_PRESS =
            "navigation_app_switch_long_press";

    private SwitchPreference mNavbarEnabled;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNavbarEnabled = (SwitchPreference) findPreference(NAVBAR_ENABLED);
        ...
        mNavbarEnabled.setChecked(showing);
        mNavbarEnabled.setOnPreferenceChangeListener(this);
