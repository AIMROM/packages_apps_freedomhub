...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String FREEDOMHUB = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, FREEDOMHUB, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, FREEDOMHUB, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(FREEDOMHUB, "interval");
            if(newInterval != null)
